  ...
  return (
    <>
      ...
      <Main>
        ...
        <ImgSpace>
          <ImgDiv>
            {overview && <Img src={mercury} />}
            {structure && <Img src={mercuryint} />}
            {surface && <Imggeo src={mercurygeo} />}
          </ImgDiv>
        </ImgSpace>
        <Section>
          <Info>
            <TitleBox>
              ...
              <Source>
                ...
                {overview && !sourceText && (
                  <Link href={Data.overview.source} target="_blank">
                    Wikipedia
                  </Link>
                )}
                {structure && (
                  <Link href={Data.structure.source} target="_blank">
                    Wikipedia
                  </Link>
                )}
                {sourceText && (
                  <Link href={Data.geology.source} target="_blank">
                    Wikipedia
                  </Link>
                )}
                <SrcImg src={source} />
