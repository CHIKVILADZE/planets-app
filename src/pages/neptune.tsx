...
export default function Neptune({overview, setOverview, structure, setStructure, surface, setSurface,
  ...
  return (
    ...
    <Main>
      <MobileInfo>
        ...
        <ImgSpace>
        <ImgDiv >
            {overview && <Img src={neptune}/>}
            {structure && <Img src={neptuneint}/>}
            {surface &&  <Imggeo  src={neptunegeo}/> }
        </ImgDiv>
        </ImgSpace>
        <Section>
          <Info>
