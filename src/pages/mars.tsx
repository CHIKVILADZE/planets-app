...
export default function Mars({overview, setOverview, structure, setStructure, surface, setSurface,
  ...
  return (
    ...
    <Main>
      <MobileInfo>
        ...
        <ImgSpace>
        <ImgDiv >
            {overview && <Img src={mars}/>}
            {structure && <Img src={marsint}/>}
            {surface &&  <Imggeo  src={marsgeo}/> }
        </ImgDiv>
        </ImgSpace>
        <Section>
          <Info>
