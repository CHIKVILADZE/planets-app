...
export default function Jupiter({overview, setOverview, structure, setStructure, surface, setSurface,
  ...
  return (
    ...
    <Main>
      <MobileInfo>
        ...
        <ImgSpace>
        <ImgDiv >
            {overview && <Img src={jupiter}/>}
            {structure && <Img src={jupiterint}/>}
            {surface &&  <Imggeo  src={jupitergeo}/> }
        </ImgDiv>
        </ImgSpace>
        <Section>
          <Info>
