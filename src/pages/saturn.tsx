...
export default function Saturn({overview, setOverview, structure, setStructure, surface, setSurface,
  ...
  return (
    ...
    <Main>
      <MobileInfo>
        ...
        <ImgSpace>
        <ImgDiv >
            {overview && <Img src={saturn}/>}
            {structure && <Img src={saturnint}/>}
            {surface &&  <Imggeo  src={saturngeo}/> }
        </ImgDiv>
        </ImgSpace>
        <Section>
          <Info>
