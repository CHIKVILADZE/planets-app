...
export default function Venus({overview, setOverview, structure, setStructure, surface, setSurface,
  ...
  return (
    ...
    <Main>
      <MobileInfo>
        ...
        <ImgSpace>
        <ImgDiv >
            {overview && <Img src={venus}/>}
            {structure && <Img src={venusint}/>}
            {surface &&  <Imggeo  src={venusgeo}/> }
        </ImgDiv>
        </ImgSpace>
        <Section>
          <Info>
