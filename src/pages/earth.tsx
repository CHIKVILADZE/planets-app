...
export default function Earth({overview, setOverview, structure, setStructure, surface, setSurface,
  ...
  return (
    ...
    <Main>
      <MobileInfo>
        ...
        <ImgSpace>
        <ImgDiv >
            {overview && <Img src={earth}/>}
            {structure && <Img src={earthint}/>}
            {surface &&  <Imggeo  src={earthgeo}/> }
        </ImgDiv>
        </ImgSpace>
        <Section>
          <Info>
